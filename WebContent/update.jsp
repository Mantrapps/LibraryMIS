						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">
									<i class="fa fa-book fa-fw"></i> Not paid fines
								</h3>
							</div>
		...
		function update() {
			$.ajax({
				...
				success : function(html) {
					$("#msg").html("<div class=\"alert alert-success\">update success!</div>");
					$("#search-responisve").html(html);
				},
				error : function(html) {
					$("#msg").html("<div class=\"alert alert-danger\">update fail!</div>");
